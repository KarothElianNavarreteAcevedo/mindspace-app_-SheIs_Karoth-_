    ...
    return (
        <main className="min-h-screen bg-background text-white font-syne max-w-md mx-auto relative overflow-x-hidden border-x border-primary/5 pt-24 pb-32 px-4">
            <header className="mb-10 relative">
                <h2 className="font-display-lg-mobile md:font-display-lg text-white mb-6 drop-shadow-[0_0_30px_rgba(0,243,255,0.6)] italic text-glow-cyan uppercase">
                    CIENCIA <span className="text-secondary italic">&amp;</span> FUTURO
                </h2>
                <div className="h-1 w-32 acid-gradient mx-auto my-6"></div>
                <p className="text-primary-fixed-dim font-label-caps drop-shadow-[0_0_10px_rgba(0,243,255,0.3)] italic font-bold">
            ...
            <section className="mb-12">
                <div className="flex justify-between items-center mb-6">
                    <h3 className="font-label-caps text-secondary text-glow-magenta">VIDEO INMERSIVO: NEUROHACKING</h3>
                ...
                <div className="flex gap-5 overflow-x-auto hide-scrollbar snap-x pb-4">
                    ...
                    <div className="flex-none w-[290px] snap-start group relative">
                        <div className="glass-card neon-border-magenta aspect-[9/16] overflow-hidden rounded-xl relative">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black via-black/80 to-transparent p-5 pt-10 pointer-events-none">
                                <span className="bg-secondary text-on-secondary font-label-caps px-3 py-1 mb-2 inline-block">STEM_HUB</span>
                                <h4 className="font-headline-lg-mobile text-white text-glow-magenta uppercase italic">Dopamina: El motor invisible</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex-none w-[290px] snap-start group relative">
                        <div className="glass-card neon-border-cyan aspect-[9/16] overflow-hidden rounded-xl relative">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black via-black/80 to-transparent p-5 pt-10 pointer-events-none">
                                <span className="bg-primary text-on-primary font-label-caps px-3 py-1 mb-2 inline-block">CAREERS</span>
                                <h4 className="font-headline-lg-mobile text-white text-glow-cyan uppercase italic">IA y el Futuro del Código</h4>
                            </div>
                        </div>
                    </div>
            ...
            <section className="mb-12">
                <div className="flex justify-between items-center mb-6">
                    <h3 className="font-label-caps text-tertiary text-glow-green">DATA &amp; CIENCIA</h3>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2 glass-card neon-border-cyan p-6 rounded-xl relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            <h4 className="font-headline-md text-primary mb-3 uppercase italic text-glow-cyan">Neuro-Génesis</h4>
                            ...
                            <div className="space-y-5">
                                <div className="flex flex-col gap-2">
                                    <div className="flex justify-between font-label-caps text-primary">
