  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'display-lg-mobile': ['40px', { lineHeight: '1.1', letterSpacing: '-0.01em', fontWeight: 800 }],
        'headline-lg': ['48px', { lineHeight: '1.2', letterSpacing: '0.05em', fontWeight: 700 }],
        'headline-lg-mobile': ['32px', { lineHeight: '1.2', fontWeight: 700 }],
        'headline-md': ['28px', { lineHeight: '1.2', letterSpacing: '0.03em', fontWeight: 700 }],
        'body-lg': ['18px', { lineHeight: '1.6', letterSpacing: '0.01em' }],
        'body-md': ['16px', { lineHeight: '1.6', letterSpacing: '0.01em' }],
        'body-sm': ['14px', { lineHeight: '1.5', letterSpacing: '0.02em' }],
        'label-lg': ['14px', { lineHeight: '1', letterSpacing: '0.1em', fontWeight: 700 }],
        'label-md': ['12px', { lineHeight: '1', letterSpacing: '0.15em' }],
        'label-caps': ['12px', { lineHeight: '1', letterSpacing: '0.2em', fontWeight: 700 }],
        'button-text': ['14px', { lineHeight: '1', letterSpacing: '0.05em', fontWeight: 700 }],
      },
      spacing: {
        'section-mobile': '48px',
